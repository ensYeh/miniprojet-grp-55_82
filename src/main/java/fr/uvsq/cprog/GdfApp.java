...
public class GdfApp {
    ...
    /**
     * Cette méthode permet de modifier le répertoire courant.
     */
    ...
    /**
     * Cette méthode permet d'execute le commande saisie par l'utilisateur.
     */
    public static String execute(String[] cmd) {
        ...
        if (cmd.length == 1 && cmd[0].equals("ls")) {
            ...
            result += "Le saisie doit être sous la forme [<NER>] [<Commande>] [<Nom>].\n"
                    ...
                    + "-[<Ner>] doit être un entier qui fait reference à "
                    + "un élément du repertoire courant.\n"
                    ...
                    + "\t- [<NER>] . : permet de entre dans un répertoire à "
                    + "condition que le NER désigne un répertoire\n"
                    + "\t- mkdir [<Nom>] : permet de créer un répertoire\n"
                    + "\t- touch [<Nom>] : permet de créer un fichier\n"
                    + "\t- [<NER>] visu : permet de voir le contenu d’un fichier texte. "
                    + "Si le fichier n’est pas de type texte, vous afficherez sa taille \n"
                    + "\t- find [<Nom>] : permet de recherche dans toutes les sous répertoires "
                    + "du répertoire courant, le(s) fichier(s) et les affiches\n"
                    + "\t- ls : permet de lister les éléments du répertoire courant\n"
                    + "\t- [<NER>] + \"texte\" : le texte est ajouté ou concaténé au texte "
                    + "existant sur l’ER !!! NB: le texte doit être entre guillemets\n"
                    ...
                    + " - 4 + \"this is notebook\" : permet d'ajouter ou concaténer "
                    + "au texte existant sur l’élément 4\n";
        } else {
