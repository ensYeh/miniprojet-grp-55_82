...
>>>>>>> Stashed changes
     ...
     * Méthode main.
     *
     * @param args doit être une liste String
     */
...
<<<<<<< Updated upstream
     ...
     *
     * @param path doit être un chaine
     */
...
>>>>>>> Stashed changes
    ...
    /**
     * Cette méthode permet d'executer les commandes saisies.
     * 
     */
...
>>>>>>> Stashed changes
            ...
            result += "Le saisie doit être sous la forme [<NER>] [<Commande>] "
                    ...
                    + "-[<Ner>] doit être un entier qui fait reference"
                        + " à un élément du repertoire courant.\n"
                    ...
                    + "\t- [<NER>] . : permet de entre dans un répertoire"
                    + " à condition que le NER désigne un répertoire\n"
                    + "\t- mkdir [<Nom>] : permet de créer un répertoire\n"
                    + "\t- touch [<Nom>] : permet de créer un fichier\n"
                    + "\t- [<NER>] visu : permet de voir le contenu d’un"
                    + "fichier texte. Si le fichier n’est pas de type texte,"
                    + " vous afficherez sa taille \n"
                    + "\t- find [<Nom>] : permet de recherche dans toutes "
                    + "les sous répertoires du répertoire courant, le(s) "
                    + "fichier(s) et les affiches\n"
                    + "\t- ls : permet de lister les éléments du répertoire"
                    + " courant\n"
                    + "\t- [<NER>] + \"texte\" : le texte est ajouté ou "
                    + "concaténé au texte existant sur l’ER !!! NB: le "
                    + "texte doit être entre guillemets\n"
                    + "\t- [<NER>] - : permet de retire tout le texte associé"
                    + " à l’ER\n"
                    + "-Exemple :\n"
                    + " - 2 copy : permet de copie l'élément 2\n"
                    + " - mkdir mydoc: permet de créer un répertoire nommé "
                    + "<mydoc>\n"
                    + " - 4 + \"this is notebook\" : permet d'ajouter ou "
                    + "concaténer au texte existant sur l’élément 4\n";
        } else {
